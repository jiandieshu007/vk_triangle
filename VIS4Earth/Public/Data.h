...
class VolumeData {
  public:
    struct LoadFromFileDesc {
        static inline ESupportedVoxelType DefVoxTy = ESupportedVoxelType::None;
        ESupportedVoxelType VoxTy = DefVoxTy;
        static inline FIntVector DefAxis = {1, 2, 3};
        FIntVector Axis = DefAxis;
        static inline FIntVector DefDimension = FIntVector::ZeroValue;
        FIntVector Dimension = DefDimension;
        FFilePath FilePath;
        FName Name;
    };
